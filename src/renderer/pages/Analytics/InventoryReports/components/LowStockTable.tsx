// src/renderer/pages/Analytics/InventoryReports/components/LowStockTable.tsx
...
const LowStockTable: React.FC<Props> = ({ data, loading }) => {
  if (loading) {
    return (
              ...
              data.map((item) => (
                ...
                >
                  ...
                  <td className="py-3 px-5 text-right">
                    <span className="px-2 py-1 rounded-full text-xs font-medium bg-[var(--accent-amber-light)] text-[var(--accent-amber)]">
                      {item.totalStock} kg
                    </span>
                  </td>
