    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
      {links.map((link) => (
        <button
          ...
          className="group relative bg-[var(--card-bg)] backdrop-blur-sm border border-[var(--border-color)] rounded-2xl p-5 text-left transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:border-[var(--accent-gold)]/50 hover:-translate-y-1 overflow-hidden"
        >
          ...
          <div className="relative z-10">
            <div className="w-12 h-12 rounded-xl bg-[var(--accent-gold-light)] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
              <link.icon className="w-6 h-6 text-[var(--accent-gold)] group-hover:text-[var(--accent-gold-hover)]" />
            </div>
