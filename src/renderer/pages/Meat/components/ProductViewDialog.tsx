...
import { X, Loader2, Package, Check, Beef, Calendar, Hash } from "lucide-react";
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-4 mt-1">
                              <span className="text-xs text-[var(--text-tertiary)]">
                                Remaining: <span className="font-semibold text-[var(--text-primary)]">
