...
import { Loader2, Save, Barcode, Upload, Image as ImageIcon, X } from "lucide-react";
...
import type { MeatFormData } from "../hooks/useMeatForm";
...
export const MeatFormDialog: React.FC<MeatFormDialogProps> = ({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={mode === "add" ? "Add New Meat" : "Edit Meat"}
      size="lg"
