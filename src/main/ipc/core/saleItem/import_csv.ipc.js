// src/main/ipc/core/saleItem/import_csv.ipc.js
...
module.exports = async (params, queryRunner) => {
  ...
  try {
    ...
    const result = await saleItemService.importFromCSV(filePath, user, queryRunner);
    return {
      status: true,
    ...
    return {
      status: false,
      message: error.message || "Failed to import sale items",
      data: null,
    };
  }
};