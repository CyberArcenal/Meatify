// src/main/ipc/core/sale/bulk_update.ipc.js
//@ts-check
...
module.exports = async (params, queryRunner) => {
  ...
  try {
    const result = await saleService.bulkUpdate(updatesArray, user, queryRunner);
    return {
      status: true,
    ...
    console.error("Error in bulkUpdateSales:", error);
    return {
      status: false,
