// src/main/ipc/core/sale/import_csv.ipc.js
...
module.exports = async (params, queryRunner) => {
  ...
  try {
    ...
    const result = await saleService.importFromCSV(filePath, user, queryRunner);
    return {
      status: true,
    ...
    console.error("Error in importSalesCSV:", error);
    return {
      status: false,
