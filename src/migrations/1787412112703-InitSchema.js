 ...
 */
module.exports = class InitSchema1787412112703 {
    name = 'InitSchema1787412112703'

    /**
     * @param {QueryRunner} queryRunner
     */
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "temporary_customers" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "contactInfo" varchar, "email" varchar, "phone" varchar, "loyaltyPointsBalance" integer NOT NULL DEFAULT (0), "lifetimePointsEarned" integer NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('regular','vip','elite') ) NOT NULL DEFAULT ('regular'), "createdAt" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updatedAt" datetime, "isActive" boolean NOT NULL DEFAULT (1))`);
        await queryRunner.query(`INSERT INTO "temporary_customers"("id", "name", "contactInfo", "email", "phone", "loyaltyPointsBalance", "lifetimePointsEarned", "status", "createdAt", "updatedAt") SELECT "id", "name", "contactInfo", "email", "phone", "loyaltyPointsBalance", "lifetimePointsEarned", "status", "createdAt", "updatedAt" FROM "customers"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`INSERT INTO "customers"("id", "name", "contactInfo", "email", "phone", "loyaltyPointsBalance", "lifetimePointsEarned", "status", "createdAt", "updatedAt") SELECT "id", "name", "contactInfo", "email", "phone", "loyaltyPointsBalance", "lifetimePointsEarned", "status", "createdAt", "updatedAt" FROM "temporary_customers"`);
